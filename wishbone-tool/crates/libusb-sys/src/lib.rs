...
use libc::{c_char, c_int, c_short, c_uchar, c_uint, c_void, intptr_t, size_t, ssize_t, timeval};
...
pub type libusb_log_cb =
    extern "C" fn(ctx: *mut libusb_context, log_level: c_int, msg: *const c_char) -> c_int;
