...
project = u'wishbone-utils'
copyright = u'2020, wishbone-utils authors'
author = u'wishbone-utils authors'
...
html_theme_options = {
    ...
    'header_links': [
        ...
        ("GitHub", "https://github.com/litex-hub/wishbone-utils",
         True, 'link'),
    ],
...
man_pages = [
    (master_doc, 'wishbone-util', u'wishbone utils Documentation', [author], 1)
]
...
texinfo_documents = [
    (
        ...
        'wishbone-utils', 'One line description of project.', 'Miscellaneous'),
]
